...
public class Payment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView paytm = (TextView) findViewById(R.id.payment_paytm);
        //TextView cashOnDelivery = (TextView) findViewById(R.id.payment_CashOnDelivery);
